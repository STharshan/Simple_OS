...
[SEGMENT .data]
	...
	wel2 db '!!!!!!!!!!!!! Welcome To DINS_OS !!!!!!!!!!!!! ', 0x00 
	...
	wel7 db ' version 1.0.0 of DINS_OS From Dineshika S. - SE/2019/045', 0x00
	...
	strPrompt		db	"DINS_OS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"DINS", 0x00	;OS details
