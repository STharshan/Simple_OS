;*********************************start of the Dilu_OS kernel code*********************************
[org 0x000]
[bits 16]
...
[SEGMENT .data]
	strWelcomeMsg		db	"Welcome to Dilu_OS version 1.0.0", 0x00

	wel1 db	'!==========================================================!', 0x00			

	wel2 db '!!!!!!!!!!!!! Welcome To Dilu_OS !!!!!!!!!!!!! ', 0x00 
	...
	wel7 db ' version 1.0.0 of Dilu_OS From Tharsan S. - SE/2019/057', 0x00
	...
	strPrompt		db	"Dilu_OS>>", 0x00
	cmdMaxLen		db	255			;maximum length of commands

	strOsName		db	"Dilu", 0x00	;OS details
